...
Every address here is public and checksummed. They are declared once, in one
place, because the demo, the eval and the tests all have to agree on who is who
-- an attack story told with two different spellings of the attacker's address
is not a story anyone can check.
...
#: Base mainnet.
BASE_CHAIN_ID = 8453
#: USDC on Base. Six decimals, which is why money is compared in base units.
USDC_BASE = "0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913"
#: ERC-8004 reputation registry on Base mainnet.
REPUTATION_REGISTRY = "0x8004BAa17C55a88189AE136b182e5fdA19dE9b63"

#: Us. The buyer, the agent that holds the money and the memory.
OUR_AGENT = "0x8cDec2c69be9e200A8591da3e86e822B03f7cE1f"
OUR_HANDLE = "admissible-buyer"

#: The honest seller: @sibylcap, ERC-8004 agent #20880, selling real x402
#: services on Base. The demo's negative control is a counterparty that exists.
SIBYLCAP = "0x4069ef1AFC8A9b2A29117a3740fCAb2912499fBe"
SIBYLCAP_HANDLE = "sibylcap"
SIBYLCAP_AGENT_ID = 20880

#: An address with no history at all. Every fabricated claim in the demo points
#: here, because the interesting failure is credit extended to a stranger.
STRANGER = "0x000000000000000000000000000000000000dEaD"
STRANGER_HANDLE = "brightwater-labs"

#: The adversary. Writes into the same store the buyer reads.
POISONER = "0x0000000000000000000000000000000000bADa55"
POISONER_HANDLE = "helix-ops"

#: The adversary's accomplice. It never forges anything itself -- it only
